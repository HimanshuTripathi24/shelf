      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-page {
          ...
          padding: 24px;
          background: radial-gradient(ellipse 80% 80% at 50% 0%, #1a0d2e33, transparent), #080808;
        }
        .auth-box {
        ...
        .auth-logo {
          ...
          color: #fff; font-size: 20px; font-weight: 700; letter-spacing: 0.3em;
        ...
        .google-btn {
          ...
          padding: 13px 20px; font-size: 14px; font-family: 'Georgia', serif; font-weight: 700;
        ...
        .form-input {
          ...
          font-family: 'Georgia', serif; outline: none; transition: border-color 0.2s; width: 100%;
        }
        .form-input:focus { border-color: rgba(200,169,110,0.5); }
        .form-input::placeholder { color: rgba(255,255,255,0.2); }

        .auth-submit {
          width: 100%; background: #c8a96e; color: #080808; border: none; border-radius: 8px;
          padding: 13px 20px; font-size: 13px; font-family: 'Georgia', serif; font-weight: 700;
          letter-spacing: 0.12em; text-transform: uppercase; cursor: pointer; transition: all 0.2s; margin-top: 4px;
        }
        ...
        .auth-note { font-size: 11px; color: rgba(255,255,255,0.2); text-align: center; margin-top: 12px; line-height: 1.6; }
        ...
        .auth-toggle button {
          ...
          font-family: 'Georgia', serif; font-size: 13px; text-decoration: underline; margin-left: 4px;
        }
        .auth-back {
          display: block; text-align: center; margin-top: 20px; font-size: 12px;
          color: rgba(255,255,255,0.25); text-decoration: none; letter-spacing: 0.08em; transition: color 0.2s;
        }
        ...
        <div className="auth-box">
          ...
          <p className="auth-subtitle">
            {mode === "signin"
              ...
              : "Join to track and sync your novels"}
          </p>
...
export default function AuthPage() {
  return (
    <Suspense fallback={
      <div style={{ background: "#080808", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", color: "rgba(255,255,255,0.3)", fontFamily: "Georgia, serif" }}>
        Loading...
      </div>
    }>
      <AuthContent />
